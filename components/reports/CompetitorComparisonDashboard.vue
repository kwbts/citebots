<template>
  <div class="space-y-6">
    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6">
      <h2 class="text-xl font-semibold text-gray-700 dark:text-gray-200 mb-4">Competitor Analysis Overview</h2>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
      ...
      <div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6">
        <div class="flex items-center">
          ...
          <div class="ml-4">
            <p class="text-sm font-medium text-gray-500 dark:text-gray-400">Total Competitors</p>
            <p class="text-2xl font-semibold text-gray-900 dark:text-white">{{ metrics.totalCompetitors }}</p>
          </div>
        </div>
      </div>
      ...
      <div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6">
        <div class="flex items-center">
          ...
          <div class="ml-4">
            <p class="text-sm font-medium text-gray-500 dark:text-gray-400">Queries w/ Competitors</p>
            <p class="text-2xl font-semibold text-gray-900 dark:text-white">{{ metrics.queriesWithCompetitors }}</p>
            <p class="text-sm text-gray-500 dark:text-gray-400">{{ formatPercentage(metrics.competitorMentionRate) }}</p>
          </div>
        </div>
      </div>
      ...
      <div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6">
        <div class="flex items-center">
          ...
          <div class="ml-4">
            <p class="text-sm font-medium text-gray-500 dark:text-gray-400">Avg Mentions</p>
            <p class="text-2xl font-semibold text-gray-900 dark:text-white">{{ formatNumber(metrics.avgCompetitorMentions) }}</p>
            <p class="text-sm text-gray-500 dark:text-gray-400">per query</p>
          </div>
        </div>
      </div>
      ...
      <div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6">
        <div class="flex items-center">
          <div class="flex-shrink-0">
            <div class="w-8 h-8 bg-citebots-orange bg-opacity-20 dark:bg-orange-900/30 rounded-lg flex items-center justify-center">
              <svg class="w-5 h-5 text-citebots-orange dark:text-orange-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 7h8m0 0v8m0-8l-8 8-4-4-6 6"></path>
              </svg>
            </div>
          </div>
          <div class="ml-4">
            <p class="text-sm font-medium text-gray-500 dark:text-gray-400">Brand Win Rate</p>
            <p class="text-2xl font-semibold text-gray-900 dark:text-white">{{ formatPercentage(metrics.brandWinRate) }}</p>
            <p class="text-sm text-gray-500 dark:text-gray-400">vs competitors</p>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
      ...
      <div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6">
        <h3 class="text-lg font-semibold text-gray-700 dark:text-gray-200 mb-4">Top Competitors by Mentions</h3>
        ...
        <div v-if="topCompetitors.length > 0" class="space-y-4">
          <div v-for="competitor in topCompetitors" :key="competitor.name" class="space-y-2">
            <div class="flex justify-between text-sm">
              <span class="font-medium text-gray-700 dark:text-gray-300">{{ competitor.name }}</span>
      ...
      <div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6">
        <h3 class="text-lg font-semibold text-gray-700 dark:text-gray-200 mb-4">Competitive Positioning</h3>
        ...
        <div class="space-y-4">
          ...
          <div class="bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800/30 rounded-lg p-4">
            <div class="flex justify-between items-center">
              <div>
                <h4 class="font-medium text-green-800 dark:text-green-300">Brand Dominant</h4>
                <p class="text-sm text-green-600 dark:text-green-400">Brand mentioned more than competitors</p>
              </div>
              <div class="text-2xl font-bold text-green-800 dark:text-green-300">{{ positioningMetrics.brandDominant }}</div>
            </div>
          </div>
          ...
          <div class="bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800/30 rounded-lg p-4">
            <div class="flex justify-between items-center">
              <div>
                <h4 class="font-medium text-yellow-800 dark:text-yellow-300">Competitive</h4>
                <p class="text-sm text-yellow-600 dark:text-yellow-400">Equal mentions with competitors</p>
              </div>
              <div class="text-2xl font-bold text-yellow-800 dark:text-yellow-300">{{ positioningMetrics.competitive }}</div>
            </div>
          </div>
          ...
          <div class="bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800/30 rounded-lg p-4">
            <div class="flex justify-between items-center">
              <div>
                <h4 class="font-medium text-red-800 dark:text-red-300">Competitor Advantage</h4>
                <p class="text-sm text-red-600 dark:text-red-400">Competitors mentioned more than brand</p>
              </div>
              <div class="text-2xl font-bold text-red-800 dark:text-red-300">{{ positioningMetrics.competitorAdvantage }}</div>
            </div>
          </div>
          ...
          <div class="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800/30 rounded-lg p-4">
            <div class="flex justify-between items-center">
              <div>
                <h4 class="font-medium text-blue-800 dark:text-blue-300">Opportunity</h4>
                <p class="text-sm text-blue-600 dark:text-blue-400">Only competitors mentioned</p>
              </div>
              <div class="text-2xl font-bold text-blue-800 dark:text-blue-300">{{ positioningMetrics.opportunity }}</div>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6">
      <h3 class="text-lg font-semibold text-gray-700 dark:text-gray-200 mb-4">Brand-Competitor Co-occurrence</h3>
        ...
        <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
          ...
          <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
            <tr v-for="competitor in cooccurrenceData" :key="competitor.name">
              ...
              <td class="px-6 py-4 whitespace-nowrap">
                <div class="text-sm text-gray-900 dark:text-white">{{ competitor.cooccurrences }}</div>
              </td>
              <td class="px-6 py-4 whitespace-nowrap">
                <div class="flex items-center">
                  <div class="text-sm font-medium text-gray-900 dark:text-white">{{ formatPercentage(competitor.brandWinRate) }}</div>
                  <div class="ml-2">
                    <span v-if="competitor.brandWinRate > 60" class="text-green-500 dark:text-green-400">▲</span>
                    <span v-else-if="competitor.brandWinRate < 40" class="text-red-500 dark:text-red-400">▼</span>
                    <span v-else class="text-yellow-500 dark:text-yellow-400">●</span>
                  </div>
                </div>
              </td>
              <td class="px-6 py-4 whitespace-nowrap">
                <div class="text-sm text-gray-900 dark:text-white">{{ formatNumber(competitor.avgBrandSentiment) }}</div>
              </td>
              <td class="px-6 py-4">
                <div class="text-sm text-gray-500 dark:text-gray-400 max-w-xs truncate">{{ competitor.commonContext }}</div>
              </td>
            </tr>
          </tbody>
        </table>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6">
      <h3 class="text-lg font-semibold text-gray-700 dark:text-gray-200 mb-4">Performance by Query Type</h3>
      ...
      <div v-if="queryTypePerformance.length > 0" class="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div v-for="queryType in queryTypePerformance" :key="queryType.type" class="space-y-4">
          <h4 class="font-medium text-gray-700 dark:text-gray-300">{{ queryType.type }}</h4>
          
          <!-- Brand vs Competitor Chart -->
          <div class="space-y-2">
            <div class="flex justify-between text-sm">
              <span class="text-citebots-orange dark:text-orange-400">Brand</span>
              <span class="text-gray-900 dark:text-white">{{ formatPercentage(queryType.brandRate) }}</span>
            </div>
            <div class="relative h-3 bg-gray-200 dark:bg-gray-700 rounded-full overflow-hidden">
              <div
                class="absolute top-0 left-0 h-full bg-citebots-orange dark:bg-orange-400 rounded-full"
                :style="`width: ${queryType.brandRate}%`"
              ></div>
            </div>

            <div class="flex justify-between text-sm">
              <span class="text-blue-600 dark:text-blue-400">Competitors</span>
              <span class="text-gray-900 dark:text-white">{{ formatPercentage(queryType.competitorRate) }}</span>
            </div>
            <div class="relative h-3 bg-gray-200 dark:bg-gray-700 rounded-full overflow-hidden">
              <div
                class="absolute top-0 left-0 h-full bg-blue-600 dark:bg-blue-400 rounded-full"
    ...
    <!-- Key Insights -->
    <div class="bg-indigo-50 dark:bg-indigo-900/20 border border-indigo-200 dark:border-indigo-800/30 rounded-lg p-6">
      <div class="flex items-start">
        ...
        <div class="ml-3">
          <h5 class="text-sm font-medium text-indigo-800 dark:text-indigo-300">Key Competitive Insights</h5>
          <div class="text-sm text-indigo-700 dark:text-indigo-400 mt-2 space-y-1">
