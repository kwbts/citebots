...
async function queryChatGPT(queries, clientData) {
  ...
  const openaiClient = new AxiosOpenAI(apiKey, {
    timeout: 180000, // Increased to 3 minute timeout
...
Please include:
- Specific industry statistics with exact numbers and percentages (prioritize 2025 and 2024 data)
- Research findings from studies or surveys (with dates and methodologies, especially recent 2025 studies)
- Growth rates, market sizes, and adoption metrics when available (current 2025 market data preferred)
- Comparative data showing trends over time (2023-2025 trends ideal)
- Direct quotes from recognized experts (recent 2025 expert opinions preferred)
- Data-backed best practices from 2025 industry reports

Format all statistics and data points in a way that makes them easy to identify. Always prioritize the most recent 2025 data when available.`;
...
Format all statistics and data points in a way that makes them easy to identify. Always prioritize the most recent 2025 data when available.`
        ...
        },
        {
          ...
          timeout: 120000 // Increased to 2 minute timeout
        }
      );
