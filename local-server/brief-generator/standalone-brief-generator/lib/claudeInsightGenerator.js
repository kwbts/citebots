...
Write a 2-3 paragraph strategic overview that:
- Explains WHY this specific angle on the topic is right for THIS brand
- Identifies the unique perspective we should take (e.g., "focus exclusively on enterprise examples" or "emphasize automation for small teams")
- Clarifies what makes our approach different WITHOUT mentioning competitors by name
- Sets the tone: thought leadership? practical guide? contrarian take?
- Includes 2-3 key statistics from the research that support our angle

2. COMPETITIVE LANDSCAPE ANALYSIS
Provide detailed analysis of competitors found in the research data, organized by source:

A. Direct Competitors (from client competitor list):
For each competitor provided in the brand context:
- Name and domain (if mentioned in research)
- Their content approach and positioning 
- How we can differentiate from their approach
- Specific gaps in their content we can fill
- What to avoid based on their oversaturated angles

B. SEO Competitors (from search results and rankings):
For competitors discovered in search results for our target keywords:
- Domain and ranking position
- Their content strategy and angle
- Why they're ranking well
- How we can create better, more differentiated content
- Specific opportunities to outrank them

C. Content Differentiation Strategy:
- Overall positioning: How our content will be uniquely positioned
- Angle Selection: What specific angle will set us apart
- Gaps to Fill: Underserved topics or approaches in the competitive landscape
- Avoidance Strategy: Oversaturated approaches to avoid

Format as structured sections with specific examples and competitor URLs where relevant.
...
- Support our unique angle
- Are recent (preferably within 2 years)
- Include exact numbers, percentages, or growth rates
- Come with clear source attribution from the research data
Format as an array of objects with: 
{
  "statistic": "[Specific stat with exact number/percentage]", 
  "source": "[Source URL or publication name from research]",
  "context": "[Brief context about why this stat supports our angle]"
}
