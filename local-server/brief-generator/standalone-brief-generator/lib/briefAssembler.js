...
1. Has a logical narrative flow with a clear beginning, middle, and end
2. Contains 5-7 main sections (H2 level)
3. Each main section should have 2-4 sub-bullet points explaining what to cover
4. Sub-bullets should be specific and helpful for content creators
5. Follows a structure appropriate for ${params.purpose} content targeting ${params.audience}
6. Balances SEO-friendly structure with valuable, unique content
...
3. Write a brief description of why this source is valuable
4. Categorize it as one of: research, news, academic, industry

Prioritize sources that:
- Contain statistics, data, or research findings
